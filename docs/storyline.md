...
| **S2**   | AI と作る、AI と笑う           | AI トリオを軸にした新プロダクトの試作                 | AI ものづくりのリアル・運用・倫理            |
...
| 段階       | 出来事                                                                       | 出すタイミング |
| ---------- | ---------------------------------------------------------------------------- | -------------- |
| 萌芽       | Shunta が一瞬 "何か" を見る。AI トリオのモニタリングログには映らない         | S1 中盤        |
| 接触       | バグまる、本番環境に出現。倒しても増える                                     | S1 後半        |
| 違和感     | **ラボ初期の試作 AI リポジトリ** のコミットログにバグまる的シルエットが映り込む | S2 序盤        |
| 親密       | バグまる、チャッピー君のそばで何かをかばうような仕草を見せる                  | S2 終盤        |
| 共闘       | バグまるがインシデントを "助ける" 動きを見せる                                | S3 中盤        |
| 仮の真相   | バグまるは **ラボ初期の試作 AI プロトタイプの "残響"** らしい... という **仮説** に到達 | S3 終盤        |
...
- **新拠点枠**: サテライトオフィス、出張先、海外支社、ワーケーション先、
  自宅、共用カフェ
- **新プロダクト枠**: AI トリオを使った新プロダクト、別チームのプロダクト、副業プロジェクト
...
6. 終盤: ラボ初期の試作 AI ログに不可解な記録 → S2 への引き
